...
class ErrorClass implements IError
{
    ...
    {
        return $this->getWebResult(ErrorConf::FAIL_PARAM_ERROR, "参数错误");

    }

    public function failNoLogin(): WebResult
    {
        return $this->getWebResult(ErrorConf::FAIL_HAS_LOGOUT, "请登录");
    }

    public function failNoPriv(): WebResult
    {
        return $this->getWebResult(ErrorConf::FAIL_NO_PRIV, "您没有权限");
    }

    public function failTokenExpire(): WebResult
    {
        return $this->getWebResult(ErrorConf::FAIL_TOKEN_OBSOLETE, "已过期，请重新登录");
    }

    public function failNoOrder(): WebResult
    {
        return $this->getWebResult(ErrorConf::FAIL_NO_ORDER, "已过期，请重新登录");
    }
